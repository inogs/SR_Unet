...
if __name__ == "__main__":
    ...
    print(f"[pipeline_orchestrator] number_of_processes: {conf.number_of_processes}")
    print(f"[pipeline_orchestrator] number_of_threads: {conf.number_of_threads}")
