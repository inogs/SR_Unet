...
path_predictions_v3 = "/leonardo_scratch/large/userexternal/gzuccari/TEST_2/predictions.v3"
path_postprocessing = "/leonardo_scratch/large/userexternal/gzuccari/TEST_2/postprocessing"
...
if __name__ == "__main__":
    if not os.path.isdir(path_predictions_v3):
        raise FileNotFoundError(f"Predictions v3 folder not found: {path_predictions_v3}")
