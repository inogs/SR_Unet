...
def parse_input_parameters():
    parser = argparse.ArgumentParser(
        description="Split a file list into per-month file lists."
    )
    parser.add_argument(
        "-c",
        "--config",
        default=os.path.join(os.path.dirname(__file__), "conf.files.dir", "conf_split_months.json"),
...
if __name__ == "__main__":
    ...
    conf_split_months = read_split_months_conf(args.config)
